                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <form class="form-group" method="" action="">
                                <h4>Student Id :</h4> 
                                <input class="form-control" type="number" name="s_id" /><br/>
                                <input type="submit"/>
                            </form>

                            <br/><br/>
                            <c:forEach var="std" items="${std}">
                                <label><h4>Student Name : ${std.s_name}</h4></label>
                                <label><h4>Roll No : ${std.roll_no}</h4></label>
                            </c:forEach>
                            <br/><br/>
                            <table class="table table-striped">
                                ...
                                <c:forEach var="atn" items="${attendance}">
                                    <tr>
                                        <td>${atn.sa_date}</td>
                                        <td>${atn.status}</td>
                                    </tr>
