            ...
            <div class="row">
                ...
                <div class="col-7 col-md-7">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <br/>
                            <button class="btn btn-lg"><a href="/OnlineSchoolManagementSystem/add_attendance.htm">Add Attendance</a></button> 
                            <button class="btn btn-lg"><a href="/OnlineSchoolManagementSystem/attendance_search.htm">Search Attendance</a></button>
                            <br><br/>
                        </div>
                    </div>                      
                </div>
